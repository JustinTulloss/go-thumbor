...
func ExampleChain() {
	...
	fmt.Println(b.Url("foo.png"))
	fmt.Println(b.Url("foo.png").Trim())
	fmt.Println(b.TrimWithSource("top-left").Url("foo.png"))
	fmt.Println(b.FullFitIn(10, 20).Url("foo.png"))
	fmt.Println(b.FitIn(30, 40).Url("foo.png"))
	fmt.Println(b.Resize(200, -1).Url("foo.png"))
